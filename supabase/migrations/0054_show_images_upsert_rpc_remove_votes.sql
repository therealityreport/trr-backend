...
-- =============================================================================
-- Migration 0054: Remove vote_average/vote_count from show_images RPC functions
-- =============================================================================
-- Migration 0010 dropped vote_average and vote_count columns from show_images.
-- This migration updates the RPC functions to match the current schema.
