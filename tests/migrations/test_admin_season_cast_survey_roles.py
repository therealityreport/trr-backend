...
MIGRATION = REPO_ROOT / "supabase/migrations/20260716133000_admin_season_cast_survey_roles.sql"
ROLLBACK = REPO_ROOT / "docs/db/season-cast-survey-roles/20260716133000_rollback.sql"
VERIFY = REPO_ROOT / "docs/db/season-cast-survey-roles/20260716133000_verify.sql"
ROLLOUT = REPO_ROOT / "docs/db/season-cast-survey-roles/20260716133000_rollout.md"
