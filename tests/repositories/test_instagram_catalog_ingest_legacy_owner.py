...
def test_catalog_ingest_has_only_the_lifecycle_provider_import_boundary() -> None:
    ...
    assert "_load_legacy_module" not in catalog_ingest.__dict__
...
def test_fresh_import_orders_preserve_exact_identity_and_room_contracts(
    ...
    result = _run_fresh_process(
        ...
        "assert '_load_legacy_module' not in catalog.__dict__",
