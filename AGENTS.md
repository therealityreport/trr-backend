...
- Never install or upgrade Graphify automatically, upload corpus material, persist query answers into the corpus, or advance a manifest before the graph and report were written successfully.
