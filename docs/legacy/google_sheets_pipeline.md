...
> **Legacy (Google Sheets pipeline):** This document is preserved for historical reference only.
> The current Supabase-first pipeline is documented in `README.md`, `docs/architecture.md`,
