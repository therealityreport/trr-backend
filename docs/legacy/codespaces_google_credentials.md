...
> **Legacy (Google Sheets pipeline):** This document is preserved for reference only.
> For current Codespaces setup guidance, see `docs/cloud/setup_codespaces_credentials.md`.
