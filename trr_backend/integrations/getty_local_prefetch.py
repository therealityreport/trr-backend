            ...
            query_results.append(
                {
                    ...
                    "fetched_candidates_total": summary.get("fetched_candidates_total"),
                    "pagination_rewrite_detected": bool(summary.get("pagination_rewrite_detected")),
                    "request_exception_class": summary.get("request_exception_class"),
                    "request_exception_message": summary.get("request_exception_message"),
                    "request_http_status": summary.get("request_http_status"),
                    "request_redirect_url": summary.get("request_redirect_url"),
                    "page_fetcher_exception_class": summary.get("page_fetcher_exception_class"),
                    "page_fetcher_exception_message": summary.get("page_fetcher_exception_message"),
                    "proxy_fingerprint": proxy_fingerprint,
