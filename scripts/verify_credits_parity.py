...
Usage:
    ...
    PYTHONPATH=. python scripts/verify_credits_parity.py [--verbose]
    ...
    PYTHONPATH=. python scripts/verify_credits_parity.py --limit 10

    # Spot-check random people for episode appearances
    PYTHONPATH=. python scripts/verify_credits_parity.py --spot-check 10
