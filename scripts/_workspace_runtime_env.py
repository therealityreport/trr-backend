...
WORKSPACE_TO_RUNTIME_ENV = {
    "WORKSPACE_RUNTIME_CAPACITY_CONTEXT": "TRR_RUNTIME_CAPACITY_CONTEXT",
    ...
    "WORKSPACE_TRR_MODAL_SOCIAL_JOB_CONCURRENCY_LIMIT": "TRR_MODAL_SOCIAL_JOB_CONCURRENCY_LIMIT",
    "WORKSPACE_TRR_REMOTE_SOCIAL_DISPATCH_LIMIT": "SOCIAL_MODAL_DISPATCH_LIMIT",
    "WORKSPACE_TRR_REMOTE_SOCIAL_POSTS": "SOCIAL_WORKER_POOL_POSTS",
    "WORKSPACE_TRR_REMOTE_SOCIAL_COMMENTS": "SOCIAL_WORKER_POOL_COMMENTS",
    "WORKSPACE_TRR_REMOTE_SOCIAL_MEDIA_MIRROR": "SOCIAL_WORKER_POOL_MEDIA_MIRROR",
    "WORKSPACE_TRR_REMOTE_SOCIAL_COMMENT_MEDIA_MIRROR": "SOCIAL_WORKER_POOL_COMMENT_MEDIA_MIRROR",
}
...
def apply_workspace_runtime_env(
    *,
    ...
    comments_cap = workspace_env.get("WORKSPACE_TRR_REMOTE_SOCIAL_COMMENTS")
    if comments_cap and not runtime_environ.get("SOCIAL_POSTS_COMMENTS_PLATFORM_CAP_INSTAGRAM"):
        runtime_environ["SOCIAL_POSTS_COMMENTS_PLATFORM_CAP_INSTAGRAM"] = comments_cap
        applied["SOCIAL_POSTS_COMMENTS_PLATFORM_CAP_INSTAGRAM"] = comments_cap
