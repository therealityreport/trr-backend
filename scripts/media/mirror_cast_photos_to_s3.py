...
Usage:
    ...
    PYTHONPATH=. python scripts/media/mirror_cast_photos_to_s3.py --source fandom

    # Mirror TMDb photos for a specific person
    PYTHONPATH=. python scripts/media/mirror_cast_photos_to_s3.py --source tmdb --imdb-person-id nm11883948

    # Mirror Fandom gallery photos for a specific person
    PYTHONPATH=. python scripts/media/mirror_cast_photos_to_s3.py --source fandom-gallery --imdb-person-id nm11883948

    # Mirror and prune orphaned S3 objects
    PYTHONPATH=. python scripts/media/mirror_cast_photos_to_s3.py --source all --prune --imdb-person-id nm11883948
"""
