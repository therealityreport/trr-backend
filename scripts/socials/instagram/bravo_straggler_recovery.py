...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--approved-shortcode", action="append", help="Approved shortcode. Repeatable or comma-separated.")
    parser.add_argument("--approved-shortcodes-file", help="File containing approved shortcodes, one or comma-separated.")
