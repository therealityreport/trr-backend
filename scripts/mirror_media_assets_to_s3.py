...
Usage:
    python scripts/mirror_media_assets_to_s3.py --source tmdb --limit 100 --verbose
    python scripts/mirror_media_assets_to_s3.py --status failed --max-retries 3
    python scripts/mirror_media_assets_to_s3.py --dry-run --limit 10
"""
