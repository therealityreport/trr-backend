...
def _scrape(person_name: str, *, show_name: str | None = None, mode: str = "full") -> dict[str, Any]:
    from trr_backend.integrations.getty_local_prefetch import fetch_person_getty_prefetch_payload

    result = fetch_person_getty_prefetch_payload(person_name, show_name=show_name, mode=mode)
    print(
...
if __name__ == "__main__":
    ...
    result = _scrape(args.person_name, show_name=args.show_name, mode=args.mode)
