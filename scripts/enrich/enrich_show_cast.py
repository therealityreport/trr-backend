...
Usage:
    ...
    PYTHONPATH=. python scripts/enrich/enrich_show_cast.py --show-name "Real Housewives of Salt Lake City"

    # Skip S3 mirroring (just import photos to DB)
    PYTHONPATH=. python scripts/enrich/enrich_show_cast.py --imdb-id tt1628033 --skip-s3

    # Dry run mode
    PYTHONPATH=. python scripts/enrich/enrich_show_cast.py --imdb-id tt1628033 --dry-run
